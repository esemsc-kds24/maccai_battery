...
def main() -> None:
    ...
    # Load config first so we can resolve the log directory
    cfg = load_config(args.config)

    # Logging — mirror the pattern of other pipeline steps
    log_dir = cfg.project.output_path / cfg.project.dirs.logs
    log_dir.mkdir(parents=True, exist_ok=True)
    log_file = log_dir / "06_elemental_references.log"
